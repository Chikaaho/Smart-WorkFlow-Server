...
Read `docs/governance/engineering-constitution.md` in full before changing backend code, running backend
...
Also read `../system.md` when the task uses the shared
