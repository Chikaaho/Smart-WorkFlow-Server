 ...
 *   <li>调用方负责保证 status 值合法（见 {@link com.sw.ck.workflow.entity.InstanceStatusEnum}）。</li>
 * </ul>
 */
public interface WorkflowInstanceService extends BaseService<WorkflowInstance> {
     ...
     * @param status            目标状态（{@link com.sw.ck.workflow.entity.InstanceStatusEnum#getCode()}）
     */
