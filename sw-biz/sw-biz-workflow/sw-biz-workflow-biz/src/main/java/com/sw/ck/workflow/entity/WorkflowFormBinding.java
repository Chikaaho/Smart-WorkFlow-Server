 ...
 * 同租户下同表单最多一条启用绑定（{@code active=true}），由唯一索引 {@code uk_sw_wf_binding_active} 保证。
 * </p>
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("sw_workflow_form_binding")
public class WorkflowFormBinding extends BaseEntity {
