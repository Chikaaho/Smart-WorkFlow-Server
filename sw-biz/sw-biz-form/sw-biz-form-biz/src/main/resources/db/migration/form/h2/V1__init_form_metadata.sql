-- ===================================================================
-- Smart-WorkFlow :: Form 模块固定元数据表 (H2)
-- ===================================================================
...
COMMENT ON COLUMN sw_form_config.definition     IS '表单样式/控件/布局 schema (JSON)';
...
COMMENT ON COLUMN sw_form_snapshot.definition     IS '该版本的完整 definition JSON 快照';
